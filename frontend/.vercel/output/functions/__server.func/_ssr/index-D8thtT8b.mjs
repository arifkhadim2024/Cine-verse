...
import { L as Layout } from "./Layout-CewSggzF.mjs";
import { M as MovieCard } from "./MovieCard-C6PcTlYN.mjs";
import { c as continueWatching, g as genres, G as GENRE_IDS, a as api } from "./router-B2s4BbaU.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 mt-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4", children: genres.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        ...
        q: g
      }, className: "group relative block aspect-[16/10] rounded-xl overflow-hidden shadow-card hover:shadow-red transition-all hover:scale-[1.03]", children: [
        genreImages[g] ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: genreImages[g], alt: g, className: "absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110", loading: "lazy" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 bg-gradient-to-br ${genreColors[g]}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/85 via-black/40 to-black/10 group-hover:from-black/90 transition-colors duration-300" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-end p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl sm:text-3xl drop-shadow-lg text-white", children: g }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3 w-8 h-8 grid place-items-center rounded-full glass opacity-0 group-hover:opacity-100 transition-opacity text-white", children: "→" })
      ] }) }, g)) })
    ] }),
