...
const appCss = "/assets/styles-Dhd4hQ2E.css";
...
const $$splitComponentImporter$8 = () => import("./watchlist-CsKtO_M9.mjs");
const Route$8 = createFileRoute("/watchlist")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./search-B06uu9Uw.mjs");
...
const $$splitComponentImporter$6 = () => import("./profile-CqGE-il2.mjs");
const Route$6 = createFileRoute("/profile")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./login-DWgLCKLO.mjs");
const Route$5 = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./genres-DnucWycJ.mjs");
const Route$4 = createFileRoute("/genres")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./ai-DYSTO1b9.mjs");
const Route$3 = createFileRoute("/ai")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-BWlL9Qcx.mjs");
const Route$2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitNotFoundComponentImporter = () => import("./movie._id-BN_SarN1.mjs");
const $$splitComponentImporter$1 = () => import("./movie._id-CtHybSid.mjs");
const Route$1 = createFileRoute("/movie/$id")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  notFoundComponent: lazyRouteComponent($$splitNotFoundComponentImporter, "notFoundComponent")
});
const $$splitComponentImporter = () => import("./genre._id-CzkZAa26.mjs");
