...
import { b as Route$1, u as useAuth, a as api } from "./router-B2s4BbaU.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { D as DetailSkeleton } from "./SkeletonLoader-czYsnFCo.mjs";
import { A as ArrowLeft, m as Calendar, n as Clock, P as Play, o as Tv, d as Plus, H as Heart, p as Share2, F as Film, q as ExternalLink, r as Pause, R as Rewind, s as FastForward, V as VolumeX, t as Volume2, u as Maximize, v as Server, S as Sparkles, j as Info, w as Layers, X } from "../_libs/lucide-react.mjs";
...
function CinemaPlayer({ movie, autoPlay = true }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between px-4 py-3 bg-zinc-900/95 border-b border-white/10 backdrop-blur-md gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-video w-full bg-black flex items-center justify-center overflow-hidden", children: selectedServer === "cloud" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full h-full group bg-black", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-between p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-center text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold tracking-wider uppercase px-2 py-1 rounded bg-black/60 backdrop-blur-sm", children: "CineVerse Direct 4K Stream" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-zinc-900/90 border-t border-white/10 flex flex-col gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "🎬 Official HD Stream / Preview (Active)"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "🍿 Direct Player (Ad-Free 4K)"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-2.5 rounded-xl bg-white/5 text-xs text-muted-foreground border border-white/5", children: [
