  ...
  head: () => ({
    meta: [
      ...
      { title: "CineVerse AI — Discover movies that match your mood" },
      {
        name: "description",
        content:
          "AI-powered movie recommendations. Search by genre, actor, or mood. Track your watchlist and chat with our cinematic AI assistant.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6e945dd1-b830-46d5-b3e7-137c76c0087d/id-preview-d130a10f--e9b1fae6-24df-4b84-a181-7d270bc0763b.lovable.app-1779641904197.png",
      },
      {
        name: "twitter:image",
        content:
