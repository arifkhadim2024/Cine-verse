...
export const mockMovies: Movie[] = [
  {
    ...
    description:
      "When a deaf cartographer inherits a remote lighthouse, she begins to hear voices that should not exist. A slow-burn descent into a haunting that listens back.",
  ...
  },
  {
    ...
    description:
      "In a vertical city stacked a mile high, a courier discovers her cargo is a memory that can topple governments. A breakneck cyberpunk thriller.",
  ...
  },
  {
    ...
    description:
      "Two insomniac strangers meet at a 24-hour diner and decide to stay awake for one perfect night. Warm, witty, and unexpectedly tender.",
  ...
  },
  {
    ...
    description:
      "A retired assassin is pulled back into a single-night gauntlet across Tokyo's underworld. Pure adrenaline choreography.",
  ...
  },
  {
    ...
    description:
      "A marine biologist and a lighthouse keeper share one summer that bends time. Lyrical, aching, unforgettable.",
  ...
  },
  {
    ...
    description:
      "A physicist discovers reality is a recursive document — and someone is editing it in real time. A mind-bending puzzle box.",
  ...
  },
  {
    ...
    description:
      "A family moves into a Victorian estate where every door opens to a room that wasn't there yesterday.",
    mood: ["dark", "scary"],
    streaming: ["Netflix", "Prime"],
  ...
  },
  {
    ...
    description:
      "A masterless swordsman walks across a flooded Edo searching for the rainmaker who killed his sister. Hand-drawn poetry.",
  ...
  },
  {
    ...
    description:
      "An expedition to an unmapped volcano in the Andes turns into a fight for survival when the mountain awakens.",
    mood: ["intense", "epic"],
    streaming: ["Disney+"],
  ...
  },
  {
    ...
    description:
      "HR at a monster staffing agency tries to mediate between a vampire CEO and a werewolf intern. A workplace comedy with bite.",
    mood: ["funny", "weird"],
    streaming: ["Hulu"],
  ...
  },
  {
    ...
    description:
      "A detective with weeks to live takes one last cold case. Every clue is a memory he's afraid to keep.",
    mood: ["sad", "noir", "dark"],
    streaming: ["Mubi"],
  ...
  },
  {
    ...
    cast: ["Voice cast"],
    description:
      "A shy girl discovers her school floats between worlds at midnight. Whimsical, painterly, full of wonder.",
